...
slug: liberica-nik/how-to/using-nik-with-desktop-applications
...
Download the package and follow <VersionLink to="install-guide">the instructions</VersionLink> to install the utility on your platform.
...
For our demo, we will use Liberica NIK 22.3.1 for Java 17. [Download](https://bell-sw.com/pages/downloads/native-image-kit/) the utility for your platform and follow <VersionLink to="install-guide">the instructions</VersionLink> to complete the installation. Set `$PATH` to Liberica NIK:
