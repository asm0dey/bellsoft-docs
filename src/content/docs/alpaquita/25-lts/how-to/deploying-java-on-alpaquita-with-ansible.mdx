...
slug: alpaquita/25-lts/how-to/deploying-java-on-alpaquita-with-ansible
...
In Alpaquita, packages are managed by [APK](/bellsoft-docs/alpaquita/25-lts/how-to/apk-guide/), so you can use the `community.general.apk` Ansible module for package installation.
...
See the [OpenRC documentation](https://github.com/OpenRC/openrc/blob/master/service-script-guide.md) and [Setting up OpenRC init system](/bellsoft-docs/alpaquita/25-lts/how-to/openrc-for-systemd-adepts/) for additional information on OpenRC services.
