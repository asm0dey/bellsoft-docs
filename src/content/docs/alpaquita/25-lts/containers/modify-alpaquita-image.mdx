...
slug: alpaquita/25-lts/containers/modify-alpaquita-image
...
[BellSoft](https://bell-sw.com/) maintains a number of [Alpaquita Linux container images](https://bell-sw.com/alpaquita-containers/). The full list of images is also available in the [Alpaquita Linux: Getting started with images](/bellsoft-docs/alpaquita/25-lts/how-to/images-getting-started-guide/) document.
