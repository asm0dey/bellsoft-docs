...
slug: alpaquita/stream/general/release-notes
...
- `alpaquita-installer` - Cross-libc installer for Alpaquita Linux that supports non-interactive installation process. See the [Alpaquita Linux Installation Guide](/bellsoft-docs/alpaquita/stream/general/install-guide/) for details.
...
Alpaquita installation procedures are described in the [Alpaquita Linux Installation Guide](/bellsoft-docs/alpaquita/stream/general/install-guide/). Typical process for installing from the ISO image requires access to a command line interpreter and contains several steps.
