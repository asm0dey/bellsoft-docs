...
slug: alpaquita/containers/modify-alpaquita-image
...
[BellSoft](https://bell-sw.com/) maintains a number of [Alpaquita Linux container images](https://bell-sw.com/alpaquita-containers/). The full list of images is also available in the [Alpaquita Linux: Getting started with images](https://docs.bell-sw.com/alpaquita-linux/stream/how-to/images-getting-started-guide/) document.
