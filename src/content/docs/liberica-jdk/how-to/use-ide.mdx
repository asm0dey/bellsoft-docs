...
slug: liberica-jdk/how-to/use-ide
...
In this document, you will learn how to use Liberica JDK in your IDE. For the general installation instructions, see the <VersionLink to="install-guide">Liberica JDK Installation Guide</VersionLink>.
...
To run Java within Visual Studio Code, you need to install a JDK. For the installation instructions, see the <VersionLink to="install-guide">Liberica JDK Installation Guide</VersionLink>.
...
1. Download and install the required version of Liberica JDK. See the <VersionLink to="install-guide">Liberica JDK Installation Guide</VersionLink> for details.
...
If you are installing NetBeans for the first time and want to use Liberica JDK for all of your Java projects, first <VersionLink to="install-guide">install Liberica JDK on your computer</VersionLink> and then choose Liberica JDK as the JDK for NetBeans IDE during the installation.
...
If you are installing Eclipse for the first time and want to use Liberica JDK as a default JRE for all of your Java projects, first <VersionLink to="install-guide">install Liberica JDK on your computer</VersionLink> and then choose Liberica JDK as the JDK for Eclipse IDE during the installation.
